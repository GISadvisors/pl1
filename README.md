...
### You must enable GitHub pages to view HTML documents at the url `abuthaya.github.io/pl1/`. 
...
Now your repository will be accessible under GitHub Pages (an HTML Web Server) at `https://abuthaya.github.io/pl1`. Note you must type this manually into the URL above, or better yet, modify the ReadMe.md to change [username] to be your actual username! 
